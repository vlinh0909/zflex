 ...
 */
class Category extends \ZFlex\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'name', 'order_by', 'rent', 'image');
        }
    ...
    public function setOrderBy($order_by)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOrderBy', array($order_by));
