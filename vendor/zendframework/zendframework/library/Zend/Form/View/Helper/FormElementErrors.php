...
class FormElementErrors extends AbstractHelper
{
     ...
     */
    protected $messageCloseString     = '</small></li></ul>';
    protected $messageOpenFormat      = '<ul%s><li><small class="form-text text-muted">';
    protected $messageSeparatorString = '</small></li><li><small class="form-text text-muted">';
    /**@-*/
